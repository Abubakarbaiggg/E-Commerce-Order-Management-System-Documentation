                                        ...
                                        <tr class="bg-white hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4 border-b">
                                                <div class="flex justify-center space-x-2">
                                                    <label for="edit-modal-{{ $role->id }}"
                                                        class="cursor-pointer bg-transparent hover:bg-neutral-500 text-neutral-700 hover:text-white py-2 px-4 border border-neutral-500 hover:border-transparent rounded">
                                                        <i class="fa-solid fa-user-check"></i>
                                                    </label>
                                                    <input type="checkbox" id="edit-modal-{{ $role->id }}"
                                                        class="peer hidden">
                                                    <div
                                                        class="fixed inset-0 bg-black bg-opacity-50 hidden peer-checked:flex justify-center items-center z-50">
                                                        <div
                                                            class="bg-white w-full max-w-lg p-6 rounded-2xl shadow-lg relative animate-fadeIn">
                                                            <label for="edit-modal-{{ $role->id }}"
                                                            ...
                                                            <h2
                                                                ...
                                                                Assign Permission to {{ $role->name }}</h2>
                                                            <form action="{{ route('addPermissionToRole') }}"
                                                                ...
                                                                <div>
                                                                    <div
                                                                        class="grid grid-cols-2 gap-2 max-h-40 rounded-lg">
                                                                        @foreach ($permissions as $permission)
                                                                            <label class="flex items-center space-x-2">
                                                                                ...
                                                                                <span
                                                                                    class="text-gray-700 text-sm">{{ $permission->name }}</span>
                                                                            </label>
                                                                        @endforeach
                                                                    </div>
                                                                </div>
                                                                <div class="flex justify-end space-x-3 pt-4 border-t">
                                                                    <button type="submit"
                                                                        class="bg-transparent hover:bg-neutral-500 text-neutral-700 font-semibold hover:text-white py-2 px-4 border border-neutral-500 hover:border-transparent rounded">Submit</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
